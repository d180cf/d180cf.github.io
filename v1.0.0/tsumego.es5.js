...
(function (tsumego) {
    ...
    var Board = (function () {
        ...
        Board.prototype.stones = regeneratorRuntime.mark(function stones(b) {
            var all, _ref33, xmin, xmax, ymin, ymax, x, y, c;
            ...
            return regeneratorRuntime.wrap(function stones$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    ...
                    case 3:
                        _ref33 = !all ? block.dims(b) : [0, this.size - 1, 0, this.size - 1];
                        xmin = _ref33[0];
                        xmax = _ref33[1];
                        ymin = _ref33[2];
                        ymax = _ref33[3];
...
(function (tsumego) {
    ...
    (function (solve_1) {
        ...
        function start(args) {
            var marked3$0, _ref35, board, color, km, _ref35$tt, tt, log, expand, target, alive, debug, time, started, yieldin, remaining, ntcalls, sa, path, tags, hist, solve, moves, _move3, _iterator33, _isArray33, _i33, move, move2;

            return regeneratorRuntime.wrap(function start$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    case 0:
                        solve = function solve(color, km) {
                            var current, speed, depth, prevb, hashb, ttres, guess, result, mindepth, nodes, _iterator31, _isArray31, _i31, _ref31, _move, hash, d, trials, _iterator32, _isArray32, _i32, _ref32, _move2, s, nextkm, tag, isloop;
                            ...
                            return regeneratorRuntime.wrap(function solve$(context$4$0) {
                                while (1) switch (context$4$0.prev = context$4$0.next) {
                                    ...
                                    case 28:
                                        ...
                                        return context$4$0.abrupt('break', 54);
                                    ...
                                    case 38:
                                        ...
                                        return context$4$0.abrupt('continue', 52);
                                    ...
                                    case 57:
                                        ...
                                        return context$4$0.abrupt('break', 115);
                                    ...
                                    case 100:
                                        return context$4$0.delegateYield(solve(-color, _move2 && km), 't2', 101);
                        ...
                        _ref35 = typeof args === 'string' ? parse(args) : args;
                        board = _ref35.board;
                        color = _ref35.color;
                        km = _ref35.km;
                        _ref35$tt = _ref35.tt;
                        tt = _ref35$tt === undefined ? new tsumego.TT() : _ref35$tt;
                        log = _ref35.log;
                        expand = _ref35.expand;
