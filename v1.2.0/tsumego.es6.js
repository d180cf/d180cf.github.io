...
(function (tsumego) {
    ...
    var Board = (function () {
        ...
        Board.prototype.stones = function* stones(b) {
            ...
            var _ref36 = !all ? block.dims(b) : [0, this.size - 1, 0, this.size - 1];
            ...
            function* solve(color, km) {
                ...
                while (trials < nodes.length) {
                    ...
                    if (!_move2) {
                        ...
                        if (!board.get(target)) s = tsumego.repd.set(tsumego.stone.nocoords(-target), tsumego.infdepth);else if (color * target > 0 && alive && alive(board)) s = tsumego.repd.set(tsumego.stone.nocoords(target), tsumego.infdepth);else s = yield* solve(-color, km);
                    }
                    path.pop();
                    hist.pop();
                    _move2 && board.undo();
...
(function (tsumego) {
    ...
    var Solver = (function () {
        ...
        Solver.prototype.proofs = function* proofs(player) {
            ...
            for (var _iterator33 = this.args.expand(color), _isArray33 = Array.isArray(_iterator33), _i33 = 0, _iterator33 = _isArray33 ? _iterator33 : _iterator33[Symbol.iterator]();;) {
                var _ref32;
                ...
                if (resp * color > 0) {
                    ...
                    // or Iterable<stone>
                    yield typeof player === 'string' ? tsumego.stone.toString(_move4) : _move4;
                }
            }
        };
        ...
        Solver.prototype.tree = function* tree(player, depth) {
            ...
            function* deepen(tree) {
                var sgf = board.sgf;
                for (var _iterator34 = expand(color), _isArray34 = Array.isArray(_iterator34), _i34 = 0, _iterator34 = _isArray34 ? _iterator34 : _iterator34[Symbol.iterator]();;) {
                    var _ref33;
                    ...
                    if (board.play(_move5)) {
                        ...
                        if (dead || resp * color > 0) {
                            ...
                            if (!dead) {
                                ...
                                for (var _iterator35 = self.threats(-color), _isArray35 = Array.isArray(_iterator35), _i35 = 0, _iterator35 = _isArray35 ? _iterator35 : _iterator35[Symbol.iterator]();;) {
                                    var _ref34;
            ...
            while (true) {
                ...
                for (var _iterator36 = leaves(root), _isArray36 = Array.isArray(_iterator36), _i36 = 0, _iterator36 = _isArray36 ? _iterator36 : _iterator36[Symbol.iterator]();;) {
                    var _ref35;
