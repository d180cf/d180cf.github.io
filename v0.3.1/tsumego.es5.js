...
(function (tsumego) {
    ...
    (function (solve_1) {
        ...
        function start(args) {
            var marked3$0, _ref31, board, color, km, _ref31$tt, tt, log, expand, status, alive, stats, unodes, debug, time, started, yieldin, remaining, ntcalls, target, sa, path, tags, hist, solve, moves, _move3, _iterator31, _isArray31, _i31, move, move2;
