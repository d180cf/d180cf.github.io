...
(function (testbench) {
    ...
    var Marks = (function () {
        ...
        Marks.prototype.clear = function clear() {
            for (var _iterator4 = this.nodes(), _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
                var _ref4;
    ...
    (function (SVGGobanElement) {
        function create(board) {
            ...
            // left digits: 9, 8, 7, ...
            for (var y = 0; y < n; y++) {
                var label = stone.cc.toString(stone(0, y, 0), n).slice(1);
...
(function (testbench) {
    testbench.qargs = {};
    try {
        for (var _iterator5 = location.search.slice(1).split('&'), _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
            var _ref5;
...
(function (testbench) {
    ...
    testbench.vm = Object.defineProperties({
        ...
        tool: {
            ...
            set: function set(value) {
                for (var _iterator6 = $('#tool button').toArray(), _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
                    var _ref6;
        ...
        km: {
            ...
            set: function set(value) {
                for (var _iterator7 = $('#km button').toArray(), _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
                    var _ref7;
...
(function (testbench) {
    ...
    var Directory = (function () {
        ...
        Directory.prototype.getFolder = function getFolder(folder) {
            for (var _iterator8 = $(this.container).find('.title').toArray(), _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator]();;) {
                var _ref8;
        ...
        Directory.prototype.find = function find(path) {
            ...
            for (var _iterator9 = $(list).find('a.item').toArray(), _isArray9 = Array.isArray(_iterator9), _i9 = 0, _iterator9 = _isArray9 ? _iterator9 : _iterator9[Symbol.iterator]();;) {
                var _ref9;
        ...
        Directory.prototype.select = function select(path) {
            ...
            for (var _iterator10 = $(this.container).find('.item').toArray(), _isArray10 = Array.isArray(_iterator10), _i10 = 0, _iterator10 = _isArray10 ? _iterator10 : _iterator10[Symbol.iterator]();;) {
                var _ref10;
...
(function (testbench) {
    ...
    function dbgsolve(board, color, km, aim, tt, status, refresh) {
        ...
        breakpoints.matches = function () {
            for (var _iterator11 = breakpoints, _isArray11 = Array.isArray(_iterator11), _i11 = 0, _iterator11 = _isArray11 ? _iterator11 : _iterator11[Symbol.iterator]();;) {
                var _ref11;
                ...
                while (!isdone && !dbgbreak && !breakpoints.matches() && !stop()) {
                    ...
                    if (Date.now() > t + (testbench.qargs.freq || 250)) {
                        ...
                        if (newmoves + '' != moves + '') {
                            ...
                            for (var _iterator12 = items, _isArray12 = Array.isArray(_iterator12), _i12 = 0, _iterator12 = _isArray12 ? _iterator12 : _iterator12[Symbol.iterator]();;) {
                                var _ref12;
    ...
    window.addEventListener('load', function () {
        ...
        Promise.resolve().then(function () {
            ...
            for (var path in lsdata) {
                ...
                for (var _iterator13 = manifest.dirs, _isArray13 = Array.isArray(_iterator13), _i13 = 0, _iterator13 = _isArray13 ? _iterator13 : _iterator13[Symbol.iterator]();;) {
                    var _ref13;
                    ...
                    var _loop = function () {
                        if (_isArray14) {
                            if (_i14 >= _iterator14.length) return "break";
                    ...
                    for (var _iterator14 = dir.problems, _isArray14 = Array.isArray(_iterator14), _i14 = 0, _iterator14 = _isArray14 ? _iterator14 : _iterator14[Symbol.iterator]();;) {
                        var _ref14;
