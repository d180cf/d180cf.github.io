...
(function (tsumego) {
    ...
    (function (stone) {
        ...
        var Set = (function () {
            ...
            Set.prototype[Symbol.iterator] = regeneratorRuntime.mark(function callee$3$0() {
                var _iterator6, _isArray6, _i6, _ref6, s;

                return regeneratorRuntime.wrap(function callee$3$0$(context$4$0) {
                    while (1) switch (context$4$0.prev = context$4$0.next) {
                        case 0:
                            _iterator6 = this.stones, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();
...
(function (tsumego) {
    var Stack = (function () {
        ...
        Stack.prototype[Symbol.iterator] = regeneratorRuntime.mark(function callee$2$0() {
            var i;
...
(function (tsumego) {
    ...
    var Board = (function () {
         ...
         */
        Board.prototype.stones = regeneratorRuntime.mark(function stones(t) {
            var all, _ref44, xmin, xmax, ymin, ymax, x, y, b;
            ...
            return regeneratorRuntime.wrap(function stones$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    ...
                    case 3:
                        _ref44 = all || t == tsumego.color.black || t == tsumego.color.white ? [0, this.size - 1, 0, this.size - 1] : block.dims(t);
                        xmin = _ref44[0];
                        xmax = _ref44[1];
                        ymin = _ref44[2];
                        ymax = _ref44[3];
                    ...
                    case 11:
                        ...
                        context$3$0.next = 16;
                        return tsumego.stone.make(x, y, b);
        ...
        Board.prototype.libs = regeneratorRuntime.mark(function libs(b) {
            var _iterator11, _isArray11, _i11, _ref11, _ref112, x, y;

            return regeneratorRuntime.wrap(function libs$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    case 0:
                        _iterator11 = this.edge(b), _isArray11 = Array.isArray(_iterator11), _i11 = 0, _iterator11 = _isArray11 ? _iterator11 : _iterator11[Symbol.iterator]();
        ...
        Board.prototype.edge = regeneratorRuntime.mark(function edge(b) {
            var _block$dims2, xmin, xmax, ymin, ymax, x, y, isLib;
...
(function (tsumego) {
    ...
    (function (solve_1) {
        ...
        function start(args) {
            var marked3$0, board, tt, log, expand, debug, time, eulern, npeyes, target, alive, started, yieldin, remaining, sa, values, evalnode, eulerval, pec, path, tags, hist, genmoves, solve, moves, _move4, _iterator37, _isArray37, _i37, color, km, move, km2, move2;

            return regeneratorRuntime.wrap(function start$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    case 0:
                        solve = function solve(color, km) {
                            var current, speed, depth, prevb, hash32, hash_b, hash_w, ttres, _genmoves,
                            // generate moves and find the earliest repetition;
                            // the move casuing that repetition will not be in this list
                            nodes, rdmin, mindepth, result, trials, _move3, d, resp, nextkm, tag, isloop;
                            ...
                            return regeneratorRuntime.wrap(function solve$(context$4$0) {
                                while (1) switch (context$4$0.prev = context$4$0.next) {
                                    ...
                                    case 27:
                                        _genmoves = genmoves(color, km);
                                        nodes = _genmoves.nodes;
                                        rdmin = _genmoves.rdmin;
                                    ...
                                    case 36:
                                        ...
                                        _move3 = nodes[trials++];
                                        d = !_move3 ? tsumego.infdepth : tsumego.repd.get(_move3);
                                        resp = undefined;
                                        // the best response
                                        path.push(hash32);
                                        ...
                                        context$4$0.next = 47;
                                        return tsumego.stone.toString(_move3 || tsumego.stone.nocoords(color));
                                    ...
                                    case 56:
                                        ...
                                        tags.push(tag);
                                        return context$4$0.delegateYield(solve(-color, nextkm), "t1", 58);
                                    ...
                                    case 72:
                                        return context$4$0.delegateYield(solve(-color, km), "t2", 73);
                                    ...
                                    case 74:
                                        ...
                                        context$4$0.next = 81;
                                        return tsumego.stone.toString(tsumego.repd.set(_move3, 0) || tsumego.stone.nocoords(color)) + " ⟶ " + tsumego.stone.toString(resp);
                                    ...
                                    case 81:
                                        ...
                                        return context$4$0.abrupt("break", 91);
                        ...
                        genmoves = function genmoves(color, km) {
                            tsumego.stat.expand++;
                            var nodes = sa.reset();
                    ...
                    case 21:
                        ...
                        values = new tsumego.HashMap();
                        evalnode = tsumego.evaluate(board, target, values);
                        eulerval = new tsumego.EulerN(board, tsumego.sign(target));
                        pec = npeyes && tsumego.eyeness(board, expand(0), expand.safe);
                        path = [];
                        tags = [];
                        hist = [];
                        moves = [];
                        ...
                        _iterator37 = moves, _isArray37 = Array.isArray(_iterator37), _i37 = 0, _iterator37 = _isArray37 ? _iterator37 : _iterator37[Symbol.iterator]();
                    ...
                    case 47:
                        color = args.color;
                        km = args.km;
                        return context$3$0.delegateYield(solve(color, km || 0), "t0", 50);
                    ...
                    case 50:
                        ...
                        return context$3$0.delegateYield(solve(color, km2), "t1", 55);
...
(function (tsumego) {
    ...
    var Solver = (function () {
         ...
         * the ko master.
         */
        Solver.prototype.getValidMovesFor = regeneratorRuntime.mark(function getValidMovesFor(color) {
            var _iterator39, _isArray39, _i39, _ref38, move;

            return regeneratorRuntime.wrap(function getValidMovesFor$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    case 0:
                        _iterator39 = this.args.expand(color), _isArray39 = Array.isArray(_iterator39), _i39 = 0, _iterator39 = _isArray39 ? _iterator39 : _iterator39[Symbol.iterator]();
        ...
        Solver.prototype.threats = regeneratorRuntime.mark(function threats(color) {
            var _iterator40, _isArray40, _i40, _ref39, move, resp;
            ...
            return regeneratorRuntime.wrap(function threats$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    ...
                    case 4:
                        _iterator40 = this.args.expand(color), _isArray40 = Array.isArray(_iterator40), _i40 = 0, _iterator40 = _isArray40 ? _iterator40 : _iterator40[Symbol.iterator]();
        ...
        Solver.prototype.proofs = regeneratorRuntime.mark(function proofs(player) {
            var color, move, km, _iterator41, _isArray41, _i41, _ref40, _move5, resp;
            ...
            return regeneratorRuntime.wrap(function proofs$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    ...
                    case 7:
                        _iterator41 = this.args.expand(color), _isArray41 = Array.isArray(_iterator41), _i41 = 0, _iterator41 = _isArray41 ? _iterator41 : _iterator41[Symbol.iterator]();
                    ...
                    case 21:
                        ...
                        context$3$0.next = 26;
                        return typeof player === 'string' ? tsumego.stone.toString(_move5) : _move5;
        ...
        Solver.prototype.tree = regeneratorRuntime.mark(function tree(player, depth) {
            ...
            var marked3$0, color, move, km, self, cache, board, target, expand, pathto, parent, correct, terminal, treesize, add, UserError, deepen, leaves, root, size, _iterator44, _isArray44, _i44, _ref43, _leaf, width, leaf, final;
                ...
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    case 0:
                            ...
                            return regeneratorRuntime.wrap(function leaves$(context$4$0) {
                                while (1) switch (context$4$0.prev = context$4$0.next) {
                                    ...
                                    case 1:
                                        ...
                                        _move7 = context$4$0.t1.value;

                                        if (!board.play(tsumego.stone.fromString(_move7))) debugger; // the tree is messed up
                                        return context$4$0.delegateYield(leaves(tree[_move7]), "t2", 5);
                        ...
                        deepen = function deepen(tree) {
                            var sgf, _iterator42, _isArray42, _i42, _ref41, _move6, subtree, dead, resp, hasThreats, _iterator43, _isArray43, _i43, _ref42, threat, d, node, pass;

                            return regeneratorRuntime.wrap(function deepen$(context$4$0) {
                                while (1) switch (context$4$0.prev = context$4$0.next) {
                                    case 0:
                                        sgf = board.sgf;
                                        _iterator42 = expand(color), _isArray42 = Array.isArray(_iterator42), _i42 = 0, _iterator42 = _isArray42 ? _iterator42 : _iterator42[Symbol.iterator]();
                                    ...
                                    case 19:
                                        ...
                                        hasThreats = false;
                                        _iterator43 = self.threats(-color), _isArray43 = Array.isArray(_iterator43), _i43 = 0, _iterator43 = _isArray43 ? _iterator43 : _iterator43[Symbol.iterator]();
                    ...
                    case 26:
                        ...
                        _iterator44 = leaves(root), _isArray44 = Array.isArray(_iterator44), _i44 = 0, _iterator44 = _isArray44 ? _iterator44 : _iterator44[Symbol.iterator]();
...
// don't bother the user twice for the same position
