...
(function (tsumego) {
    ...
    var Board = (function () {
        ...
        Board.prototype.stones = regeneratorRuntime.mark(function stones(b) {
            var all, _ref35, xmin, xmax, ymin, ymax, x, y, c;
            ...
            return regeneratorRuntime.wrap(function stones$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    ...
                    case 3:
                        _ref35 = !all ? block.dims(b) : [0, this.size - 1, 0, this.size - 1];
                        xmin = _ref35[0];
                        xmax = _ref35[1];
                        ymin = _ref35[2];
                        ymax = _ref35[3];
...
(function (tsumego) {
    ...
    (function (solve_1) {
        ...
        function start(args) {
            var marked3$0, board, color, km, tt, log, expand, debug, time, target, alive, started, yieldin, remaining, sa, evalnode, path, tags, hist, solve, moves, _move3, _iterator31, _isArray31, _i31, move, move2;
            ...
            return regeneratorRuntime.wrap(function start$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    ...
                    case 44:
                        ...
                        return context$3$0.delegateYield(solve(color, move * color > 0 ? -color : color), "t1", 47);
...
(function (tsumego) {
    ...
    var Solver = (function () {
         ...
         *  `;
         */
        Solver.prototype.tree = regeneratorRuntime.mark(function tree(color, depth) {
            var marked3$0, self, cache, board, target, expand, correct, terminal, deepen, leaves, root, d, changed, _iterator35, _isArray35, _i35, _ref34, _leaf, n, width, leaf, final;
            ...
            return regeneratorRuntime.wrap(function tree$(context$3$0) {
                while (1) switch (context$3$0.prev = context$3$0.next) {
                    case 0:
                            ...
                            return regeneratorRuntime.wrap(function leaves$(context$4$0) {
                                while (1) switch (context$4$0.prev = context$4$0.next) {
                                    ...
                                    case 1:
                                        ...
                                        return context$4$0.delegateYield(leaves(tree[move]), "t2", 5);
                        ...
                        deepen = function deepen(tree, color) {
                            var sgf, _iterator33, _isArray33, _i33, _ref32, move, subtree, dead, resp, hasThreats, _iterator34, _isArray34, _i34, _ref33, threat, pass;

                            return regeneratorRuntime.wrap(function deepen$(context$4$0) {
                                while (1) switch (context$4$0.prev = context$4$0.next) {
                                    case 0:
                                        sgf = board.sgf;
                                        _iterator33 = expand(color), _isArray33 = Array.isArray(_iterator33), _i33 = 0, _iterator33 = _isArray33 ? _iterator33 : _iterator33[Symbol.iterator]();
                                    ...
                                    case 2:
                                        ...
                                        return context$4$0.abrupt("break", 55);
                                    ...
                                    case 12:
                                        ...
                                        subtree = tree[tsumego.stone.toString(move)] = {};
                                        dead = !board.get(target);
                                        resp = dead ? '' : self.solve(-color);
                                        ...
                                        hasThreats = false;
                                        _iterator34 = self.threats(-color), _isArray34 = Array.isArray(_iterator34), _i34 = 0, _iterator34 = _isArray34 ? _iterator34 : _iterator34[Symbol.iterator]();
                                    ...
                                    case 22:
                                        ...
                                        return context$4$0.abrupt("break", 37);
                    ...
                    case 19:
                        ...
                        changed = false;
                        _iterator35 = leaves(root), _isArray35 = Array.isArray(_iterator35), _i35 = 0, _iterator35 = _isArray35 ? _iterator35 : _iterator35[Symbol.iterator]();
                    ...
                    case 23:
                        ...
                        return context$3$0.abrupt("break", 41);
                    ...
                    case 36:
                        n = width(_leaf);
                        return context$3$0.delegateYield(deepen(_leaf, color), "t0", 38);
