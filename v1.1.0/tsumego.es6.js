...
(function (tsumego) {
    ...
    var Board = (function () {
        ...
        Board.prototype.stones = function* stones(b) {
            ...
            var _ref35 = !all ? block.dims(b) : [0, this.size - 1, 0, this.size - 1];
...
(function (tsumego) {
    ...
    var TT = (function () {
        ...
        TT.prototype.set = function set(hash_0, hash_1, color, move, km) {
            ...
            var _ref36 = move * color > 0 ? [tsumego.stone.x(move), tsumego.stone.y(move), tsumego.stone.hascoords(move)] : [entry.x(e), entry.y(e), entry.m(e)];
...
(function (tsumego) {
    ...
    (function (solve_1) {
        function* start(args) {
            ...
            var evalnode = tsumego.evaluate(board, target);
            ...
            function* solve(color, km) {
                ...
                var guess = tt.move.get(color > 0 ? 1 : 0, hash32);
                ...
                for (var _iterator30 = expand(color), _isArray30 = Array.isArray(_iterator30), _i30 = 0, _iterator30 = _isArray30 ? _iterator30 : _iterator30[Symbol.iterator]();;) {
                    var _ref30;
            ...
            // restore the path from the history of moves
            {
                ...
                for (var _iterator31 = moves, _isArray31 = Array.isArray(_iterator31), _i31 = 0, _iterator31 = _isArray31 ? _iterator31 : _iterator31[Symbol.iterator]();;) {
                    if (_isArray31) {
...
(function (tsumego) {
    ...
    var Solver = (function () {
        ...
        Solver.prototype.solve = function solve(color) {
        ...
        Solver.prototype.threats = function* threats(color) {
            ...
            for (var _iterator32 = this.args.expand(color), _isArray32 = Array.isArray(_iterator32), _i32 = 0, _iterator32 = _isArray32 ? _iterator32 : _iterator32[Symbol.iterator]();;) {
                var _ref31;
                ...
                if (this.args.board.play(move)) {
                    ...
                    if (tsumego.stone.fromString(resp) * color > 0) yield tsumego.stone.toString(move);
                }
            }
        };
        ...
        Solver.prototype.tree = function* tree(color, depth) {
            if (typeof color === 'string') {
                color = tsumego.stone.label.color(color);
                if (!color) throw Error('Invalid color value. Consider W or B.');
            }
            ...
            function* deepen(tree, color) {
                var sgf = board.sgf;
                for (var _iterator33 = expand(color), _isArray33 = Array.isArray(_iterator33), _i33 = 0, _iterator33 = _isArray33 ? _iterator33 : _iterator33[Symbol.iterator]();;) {
                    var _ref32;
                    ...
                    if (board.play(move)) {
                        var subtree = tree[tsumego.stone.toString(move)] = {};
                        var dead = !board.get(target);
                        var resp = dead ? '' : self.solve(-color);
                        if (!resp) {
                            ...
                            if (!dead) {
                                ...
                                for (var _iterator34 = self.threats(-color), _isArray34 = Array.isArray(_iterator34), _i34 = 0, _iterator34 = _isArray34 ? _iterator34 : _iterator34[Symbol.iterator]();;) {
                                    var _ref33;
            ...
            for (var d = 0; d < depth; d++) {
                ...
                var changed = false;
                for (var _iterator35 = leaves(root), _isArray35 = Array.isArray(_iterator35), _i35 = 0, _iterator35 = _isArray35 ? _iterator35 : _iterator35[Symbol.iterator]();;) {
                    var _ref34;
                    ...
                    var n = width(_leaf);
                    yield* deepen(_leaf, color);
                    if (width(_leaf) > n) changed = true;
                }
            ...
            function final(tree) {
                for (var move in tree) {
                    if (!leaf(tree[move])) return false;
                }return true;
            }
            return (function stringify(tree) {
                ...
                var vars = [];
                for (var move in tree) {
                    var subtree = tree[move];
                    // there is no point to explicitly list wrong moves, e.g. ;B[ef];W[cc];B[df]C[WRONG]
                    if (tsumego.stone.fromString(move) * color > 0 && !correct.has(subtree) && leaf(subtree)) continue;
                    var line = ';' + move;
                    if (correct.get(subtree)) {
                        line += 'ZZ[+]'; // simplifies debugging
                        if (leaf(subtree) || final(subtree)) line += 'C[RIGHT]';
                    }
