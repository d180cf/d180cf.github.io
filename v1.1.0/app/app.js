                ...
                $('#solve-b, #solve-w').click(function (event) {
                    ...
                    if (event.ctrlKey) {
                        (function () {
                            ...
                            var g = problem.tree(color, testbench.qargs.ptd || 2);
                            ...
                            (function next(move) {
                                ...
                                setTimeout(function () {
                                    ...
                                    if (done) {
                                        ...
                                        testbench.vm.sgf = testbench.vm.sgf.trim().replace(/\)$/, tree + ')');
                                        return;
                                    }
                                    testbench.vm.note = 'Pick the strongest response for ' + value;
                                    var svg = renderBoard();
                ...
                var _ret6 = (function () {
                    ...
                    return {
                        v: Promise.resolve().then(function () {
                            var n = 0;
                            for (var _iterator21 = problem.threats(color), _isArray21 = Array.isArray(_iterator21), _i21 = 0, _iterator21 = _isArray21 ? _iterator21 : _iterator21[Symbol.iterator]();;) {
                                var _ref21;
                                ...
                                var _stone$coords4 = stone.coords(stone.fromString(threat));

                                var x = _stone$coords4[0];
                                var y = _stone$coords4[1];
