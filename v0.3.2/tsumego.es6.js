...
(function (tsumego) {
    ...
    (function (solve_1) {
        ...
        function* start(args) {
            var _ref31 = typeof args === 'string' ? parse(args) : args;

            var board = _ref31.board;
            var color = _ref31.color;
            var km = _ref31.km;
            var _ref31$tt = _ref31.tt;
            var tt = _ref31$tt === undefined ? new tsumego.TT() : _ref31$tt;
            var log = _ref31.log;
            var expand = _ref31.expand;
            var target = _ref31.target;
            var alive = _ref31.alive;
            var stats = _ref31.stats;
            var unodes = _ref31.unodes;
            var debug = _ref31.debug;
            ...
            function* solve(color, km) {
                ...
                var nodes = sa.reset();
                for (var _iterator29 = expand(color), _isArray29 = Array.isArray(_iterator29), _i29 = 0, _iterator29 = _isArray29 ? _iterator29 : _iterator29[Symbol.iterator]();;) {
                    var _ref28;
                ...
                var trials = 0;
                for (var _iterator30 = nodes, _isArray30 = Array.isArray(_iterator30), _i30 = 0, _iterator30 = _isArray30 ? _iterator30 : _iterator30[Symbol.iterator]();;) {
                    var _ref29;
                    ...
                    debug && (yield _move2 ? tsumego.stone.toString(_move2) : tsumego.stone.label.string(color) + '[]');
                    if (!_move2) {
                        ...
                        s = !board.get(target) ? tsumego.repd.set(tsumego.stone.nocoords(-target), tsumego.infdepth) :
